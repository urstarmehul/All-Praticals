...
* The original package name 'com.in28minutes.database.database-hibernate' is invalid and this project uses 'com.in28minutes.database.databasehibernate' instead.
